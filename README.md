...
1. Express takes care of all the overhead that you would need to do in vanilla node
2. Express hangles requests simutaneously.

- [ ] Describe Middleware?
- Middleware is like a plugin on an addon that does one thing right in the proccess.

- [ ] Describe a Resource?
- A resource is an endpoint that can perform CRUD

- [ ] What can the API return to help clients know if a request was successful?
- A status code and a message

- [ ] How can we partition our application into sub-applications?
- Using routes we can nest them to create sub routes
